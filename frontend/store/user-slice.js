  ...
  updateUserProfile: async (userData) => {
    ...
    try {
      ...
      console.log('TIMESTAMP DEBUG - Current state currentUser:', {
        ...
        locationUpdatedAt: get().userSlice.currentUser ? get().userSlice.currentUser.locationUpdatedAt : null
      });
      ...
      set((state) => {
        ...
        if (response.locationUpdatedAt) {
          console.log('TIMESTAMP DEBUG - Store - response contains locationUpdatedAt:', response.locationUpdatedAt);
          ...
          try {
            ...
            if (!isNaN(date.getTime())) {
              ...
              console.log('TIMESTAMP DEBUG - Store - Using formatted locationUpdatedAt:', updatedUser.locationUpdatedAt);
            } else {
              console.error('TIMESTAMP DEBUG - Store - Invalid date in response');
            }
          } catch (err) {
            console.error('TIMESTAMP DEBUG - Store - Error parsing date:', err);
          }
        } else if (response.location) {
          console.log('TIMESTAMP DEBUG - Store - Location updated but no timestamp provided');
        }
