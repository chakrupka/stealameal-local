...
with_node \
  ...
  --target "/Users/harrybeesley-gilman/Desktop/project-stealameal/frontend/ios/Pods/Target Support Files/Pods-projectstealameal/ExpoModulesProvider.swift" \
  --entitlement "/Users/harrybeesley-gilman/Desktop/project-stealameal/frontend/ios/projectstealameal/projectstealameal.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-device" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake"
